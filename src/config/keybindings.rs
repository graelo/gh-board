...
impl BuiltinAction {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            Self::Refresh => "Refresh current filter",
            Self::RefreshAll => "Refresh all filters",
            Self::RefreshItem => "Refresh selected item",
            ...
            Self::Worktree => "Create/open git worktree",
            Self::Close => "Close",
            Self::Reopen => "Reopen",
...
pub fn default_universal() -> Vec<Keybinding> {
    vec![
        ...
        kb("l", "next_filter", "Next filter"),
        kb("right", "next_filter", "Next filter"),
        kb("p", "toggle_preview", "Toggle preview pane"),
        kb("o", "open_browser", "Open in browser"),
        kb("r", "refresh_item", "Refresh selected item"),
        kb("R", "refresh", "Refresh current filter"),
        kb("ctrl+r", "refresh_all", "Refresh all filters"),
