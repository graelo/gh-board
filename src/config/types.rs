...
fn merge_icons(base: IconConfig, overlay: IconConfig) -> IconConfig {
    IconConfig {
        ...
        ci_running: overlay.ci_running.or(base.ci_running),
        ci_skipped: overlay.ci_skipped.or(base.ci_skipped),
        ci_cancelled: overlay.ci_cancelled.or(base.ci_cancelled),
        ci_action_required: overlay.ci_action_required.or(base.ci_action_required),
        ...
        check_running: overlay.check_running.or(base.check_running),
        check_skipped: overlay.check_skipped.or(base.check_skipped),
        check_cancelled: overlay.check_cancelled.or(base.check_cancelled),
        check_action_required: overlay.check_action_required.or(base.check_action_required),
...
pub struct IconConfig {
    ...
    pub ci_running: Option<String>,
    pub ci_skipped: Option<String>,
    pub ci_cancelled: Option<String>,
    pub ci_action_required: Option<String>,
    ...
    pub check_cancelled: Option<String>,
    pub check_action_required: Option<String>,
    // Sidebar decorative
