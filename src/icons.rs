...
impl ResolvedIcons {
    ...
    fn nerdfont() -> Self {
        Self {
            ...
            view_alerts: "\u{eb53}".to_owned(), //  nf-cod-shield
            // Tab filter marker
    ...
    pub fn resolve(config: &IconConfig) -> Self {
        ...
        Self {
            ...
            view_alerts: config.view_alerts.clone().unwrap_or(base.view_alerts),
